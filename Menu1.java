...
public class Menu1{
    ...
    static void printMenu(int option){
        ...
        switch(option){
            //prints meat options
            case 0:
                System.out.println("OneStop Restaurant");
                System.out.println("Menu List");
                System.out.println(" Select Your Meat ");
                System.out.println("1. Tuna - $3");
                System.out.println("2. Beef - $2");
                System.out.println("3. Chicken - $4"); 
                break;
                //prints bread options
            case 1:
                System.out.println("Select Your Bread");
                System.out.println("4. Whole Grain - $1");
                System.out.println("5. Italian - $1.50");
                System.out.println("6. Plain White - $.75");
                break;
                //prints cheese options
            case 2:
                System.out.println("Select Your Cheese ");
                System.out.println("7. American - $0.30");
                System.out.println("8. Feta - $0.35");
                System.out.println("9. Cheddar - $0.30");
                break;
                //prints drink options
            case 3:
                System.out.println("Select Your Drink");
                System.out.println("10. Sprite - $6");
                System.out.println("11. Pepsi - $7");
                System.out.println("12. Coke - $10");
                break;
            default:
